...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.horizontalLayout_2.setStretch(3, 11)
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 885, 403))
        ...
        Form.setTabOrder(self.quit, self.next)
        Form.setTabOrder(self.next, self.scrollArea)
    ...
    def retranslateUi(self, Form):
        ...
        self.label_5.setText(_translate("Form", "  Index"))
